...
public class NewTripScreen extends AppCompatActivity {
    ...
    String[] schools={
            ...
            "Excel Academies of Cosmetology-Kentwood",
            ...
            "Graduate School USA",
            "Casa Loma College-Anaheim Campus",
            ...
            "Excel Academies of Cosmetology-Troy",
            "Excel Academies of Cosmetology-Merrillville",
            ...
            "Taylor Andrews Academy-Orem",
            "University of Florida-Online",
            "Buchanan Beauty College-Pleasantview",
            ...
            "Merrillville Beauty College-Flawless Barber Academy",
            ...
            "MJ's Barber Academy",
            "Arkansas College of Barbering & Hair Design - SWLR Campus",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        schoolNameText.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
        ...
        //Error text
        errorText = (TextView) findViewById(R.id.NewTripErrorText);
    ...
    public void onNewTripButtonClick(View view) {
        ...
        if(tripNameText.getText().toString().length() <= 0) {
            errorText.setText("You must enter a name for your trip");
            return;
        }
        ...
        if(!schoolEntered) {
            errorText.setText("You must enter a valid school name");
            return;
        }


        //Error check dates
        if(dateStartText.getText().toString().length() <= 0 || dateEndText.getText().toString().length() <= 0) {
            errorText.setText("You must enter both start and end dates");
            return;
        }
        ...
        if (startDate.after(endDate)){
            errorText.setText("Start date must come before end date");
            return;
        }

        if(budgetText.getText().toString().length() <= 0) {
            errorText.setText("You must enter a budget");
            return;
        }

        //Create new trip object
        Trip newTrip = new Trip(tripNameText.getText().toString(),
                schoolNameText.getText().toString(),
                startDate,endDate,
                Float.parseFloat(budgetText.getText().toString()),
